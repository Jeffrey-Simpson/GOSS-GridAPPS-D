...
//		responseStr = query(simulationId, null, "1532971828475", null, null).result.toString();
		...
		processWithAllTimes(expected_output_series, simulationId, responseStr);
...
//			responseStr = query(simulationId, null, time, time,  keywords).result.toString();
	...
	public void processATime(String expected_output_series, String simulationId, String responseStr, TestResultSeries testResultSeries, String index) {
...
//				System.out.println(" ");
	...
	public void processWithAllTimes(String expected_output_series, String simulationId, String response) {
		TestResultSeries testResultSeries = new TestResultSeries();
		CompareResults compareResults = new CompareResults();
...
//			String response = query(simulationId, mrid, null,null,null).result.toString();
	...
	public static void main(String[] args) {
		...
		HistoricalComparison pq = new HistoricalComparison();
